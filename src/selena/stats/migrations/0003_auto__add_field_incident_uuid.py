...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Incident.uuid'
        db.add_column(u'stats_incident', 'uuid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=36),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Incident.uuid'
        db.delete_column(u'stats_incident', 'uuid')
    ...
    models = {
        ...
        u'stats.incident': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '36'})
        }
    }
